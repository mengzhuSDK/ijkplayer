    ...
    J4A_LOAD_CLASS(tv_mengzhu_sdk_media_player_misc_IMediaDataSource);
    J4A_LOAD_CLASS(tv_mengzhu_sdk_media_player_misc_IAndroidIO);
    J4A_LOAD_CLASS(tv_mengzhu_sdk_media_player_IjkMediaPlayer);
